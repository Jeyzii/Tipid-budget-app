    ...
    <main className="flex min-h-screen items-center justify-center p-6">
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">Welcome back to your finances.</p>
        </div>
        <label className="block space-y-1.5 text-sm font-medium text-zinc-300">
          ...
          <input
            ...
            required
            autoComplete="email"
            className="w-full rounded-lg border border-zinc-700/80 bg-zinc-950/80 px-3 py-2.5 text-zinc-100 outline-none transition placeholder:text-zinc-600 focus:border-violet-500/80 focus:ring-2 focus:ring-violet-500/25"
          />
        </label>
        <label className="block space-y-1.5 text-sm font-medium text-zinc-300">
          Password
